    ...
    "1st": [
      {
        ...
        resources: {
          notes:
            "https://drive.google.com/drive/folders/13lR8bTorhzel8oIvTAxGirhCgwfFarsD",
          pyq: "",
          qb: "",
          syllabus: "",
          Qb_solutions: "",
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            and question banks organized by year and subject for your academic
            success.
          </p>
        </div>
              ...
              <div className="mt-8">
                ...
                <div className="space-y-3">
                  {resourceTypes.map((resource) => (
                    ...
                    >
                      <div
                        className={`w-8 h-8 rounded-full flex items-center justify-center ${resource.color}`}
                      >
                ...
                {subjects[selectedYear]?.map((subject) => (
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      {resourceTypes.map((resource) => {
                        const link =
                          subject.resources && subject.resources[resource.type];
                        return (
                          <div
                            key={resource.type}
                          ...
                          >
                            <div className="flex items-center space-x-3">
                              <div
                                className={`w-6 h-6 rounded-full flex items-center justify-center ${resource.color}`}
                              >
                            ...
                            {link ? (
                              <a
                                ...
                                className="px-3 py-1 bg-gray-600 text-white text-sm rounded-full hover:bg-red-700 transition-colors duration-300"
                              >
                                View
                              </a>
                            ) : (
                              <button
                                className="px-3 py-1 bg-gray-300 text-gray-500 text-sm rounded-full cursor-not-allowed"
                                disabled
                              >
                                N/A
                              </button>
              ...
              <div className="mt-12 text-center">
                <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-8">
                  ...
                  <p className="text-gray-600 mb-6">
                    ...
                    you locate the right study materials.
                  </p>
                  <Link
                    to="/#contact"
